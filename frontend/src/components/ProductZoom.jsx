  ...
  return (
    <>
      <div className="flex gap-3">
        <div className="slider w-[15%]">
          ...
          >
            <SwiperSlide>
              <div
                className={`item rounded-md overflow-hidden cursor-pointer group ${
                  slideIndex === 0 ? "opacity-full" : "opacity-30"
                }`}
                onClick={() => goto(0)}
              >
                <img
            ...
            <SwiperSlide>
              <div
                className={`item rounded-md overflow-hidden cursor-pointer group ${
                  slideIndex === 1 ? "opacity-full" : "opacity-30"
                }`} 
                onClick={() => goto(1)}
              >
                <img
            ...
            <SwiperSlide>
              <div
                className={`item rounded-md overflow-hidden cursor-pointer group ${
                  slideIndex === 2 ? "opacity-full" : "opacity-30"
                }`}
                onClick={() => goto(2)}
              >
                <img
            ...
            <SwiperSlide>
              <div
                className={`item rounded-md overflow-hidden cursor-pointer group ${
                  slideIndex === 3 ? "opacity-full" : "opacity-30"
                }`}
                onClick={() => goto(3)}
              >
                <img
        ...
        <div className="w-[85%] h-[500px] overflow-hidden rounded-md">
          <Swiper
            ref={zoomSliderBig}
            slidesPerView={1}
            spaceBetween={0}
